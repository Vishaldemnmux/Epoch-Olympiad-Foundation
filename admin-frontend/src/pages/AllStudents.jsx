...
const AllStudents = () => {
  ...
  const fetchStudents = async (page) => {
    try {
      const res = await axios.get(`${BASE_URL}/all-students?page=${page}&limit=${limit}`);
      if (res.data.success) {
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        ...
                        <span className="ml-3 font-medium">{stu.studentName}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <span className="text-gray-600">{stu.mobNo || "N/A"}</span>
                    </td>
                    <td className="px-6 py-4">
          ...
          {totalPages > 1 && (
            <div className="px-6 py-4 flex items-center justify-between bg-gray-50 border-t border-gray-200">
              <div className="text-sm text-gray-700">
                ...
                {Math.min(currentPage * limit, (currentPage - 1) * limit + students.length)} of{" "}
                {totalPages * limit} students
              </div>
